...
class UserAuthentication:
    ...
    def addToUserDataBase(self, phone_number, username):
        ...
        self.user_id_start = self.user_id_start + 1

        data = [(phone_number, username, self.user_id_start)]
    ...
    def searchUserDatabase(self, loginInfo):
        ...
        cursor.execute('''CREATE TABLE IF NOT EXISTS users (phone_number STRING UNIQUE, username STRING UNIQUE, user_id UNIQUE PRIMARY KEY)''')
